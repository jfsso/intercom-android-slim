...
# get intercom
curl -o $temp_dir/intercom-sdk-base-1.1.13.aar 'https://raw.githubusercontent.com/intercom/intercom-android/1.1.13/aar/intercom-sdk-base/intercom-sdk-base-1.1.13.aar'
curl -o $temp_dir/intercom-sdk-gcm-1.1.13.aar 'https://raw.githubusercontent.com/intercom/intercom-android/1.1.13/aar/intercom-sdk-gcm/intercom-sdk-gcm-1.1.13.aar'
...
# process base
cd $work_dir
unzip $temp_dir/intercom-sdk-base-1.1.13.aar -d $temp_dir/intercom-sdk-base
...
zip -r -X $output_dir/intercom-sdk-base-1.1.13-slim.aar *

# process gcm
cd $work_dir
unzip $temp_dir/intercom-sdk-gcm-1.1.13.aar -d $temp_dir/intercom-sdk-gcm
...
zip -r -X $output_dir/intercom-sdk-gcm-1.1.13-slim.aar *
