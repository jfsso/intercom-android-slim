...
# get intercom
curl -o $temp_dir/intercom-sdk-base-1.1.8.aar 'https://raw.githubusercontent.com/intercom/intercom-android/1.1.8/aar/intercom-sdk-base/intercom-sdk-base-1.1.8.aar'
...
# process
unzip $temp_dir/intercom-sdk-base-1.1.8.aar -d $temp_dir/intercom-sdk-base
...
zip -r -X $output_dir/intercom-sdk-base-1.1.8-slim.aar *
cd $work_dir
